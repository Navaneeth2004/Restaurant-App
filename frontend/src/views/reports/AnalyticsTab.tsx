 ...
 *
 * FIX: removed "Bill vs. Actually Paid — Today" panel — it was showing
 *      misleading data because amount_paid is stored per-order and the
 *      split payment accumulation logic had a bug. Revenue KPI now shows
 *      the bill total (what was charged), which is the standard accounting
 *      figure. The History tab shows per-session paid amounts correctly.
 */
        ...
        <div className="rounded-xl border border-surface-border bg-surface-card p-4 sm:p-5">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              { label: 'Active Days',     color: '#fff',    value: `${activeDays}`, sub: `${Math.round((activeDays / 30) * 100)}% of the month` },
