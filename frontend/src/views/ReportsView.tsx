...
export default function ReportsView() {
  ...
  // FIX #5 & #7: Chart component with NO y-axis labels (they were overlapping)
  // Instead show a clean tooltip-based approach and only show 3 x-axis labels
  const RevenueChart = () => (
    <div className="rounded-xl border border-surface-border bg-surface-card p-4 sm:p-5">
      <div className="flex items-start justify-between mb-4">
        ...
        {/* FIX #7: wrap these so they don't overlap on mobile */}
      ...
      {chart.length === 0 ? (
        ...
        <>
          {/* FIX #9: explicit pixel height bars - no y-axis labels at all to avoid overlap */}
                ...
                return (
                  <div key={i} className="flex-1 flex items-end group" style={{ height: '96px' }}
                    ...
                    <div className="w-full rounded-t-sm transition-opacity"
                      style={{ height: `${barH}px`, backgroundColor: isToday ? '#f97316' : '#f9731660',
          ...
          {/* FIX #5 #7: Only 3 x-labels, no overlap */}
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {section === 'analytics' && (
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4">
          ...
          {/* FIX #7: KPI cards - revenue text doesn't overflow */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="rounded-xl border border-surface-border bg-surface-card p-4">
                ...
                {/* FIX #7: use text-2xl on mobile, 3xl on desktop, truncate if needed */}
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5">
          ...
          {history.length === 0 ? (
            ...
            <div className="space-y-1.5">
              {/* Column header — hidden on very small screens */}
